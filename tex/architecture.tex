...
\uncover<2->{
  ...
  \tikz[overlay] \node[red] (description) at ([yshift=-32mm]instruction.south) {instruction to increment a number by 1 (for my laptop)};
...
\begin{frame}[fragile]{Data are also binary}
...
\uncover<6->{The meaning is given by the way we use data}
\begin{itemize}
...
\begin{frame}{Operating systems (highlights)}
