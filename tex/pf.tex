% Copyright 2019-2026 Istituto Nazionale di Fisica Nucleare (INFN)
% Copyright 2025-2026 Università di Bologna
...
\hypersetup{pdftitle=Programmazione per la Fisica -- 2026/2027}

\author{F.~Giacomini (A-L)\\{\tiny\url{https://www.unibo.it/sitoweb/francesco.giacomini3/}}\\
        C.~Battilana (M-Z)\\{\tiny\url{https://www.unibo.it/sitoweb/carlo.battilana2/}}}

\date{Corso di laurea in Fisica, Università di Bologna, 2026/2027}
...

{
  ...
  \begin{frame}[plain,noframenumbering]
    \begin{tikzpicture}[remember picture,overlay]
      ...
      \node (virtuale-mz) at ([yshift=.1cm]git.north) {\tiny\url{https://virtuale.unibo.it/course/view.php?id=83741} (M-Z)};
      \node (virtuale-al) at ([yshift=.1cm]virtuale-mz.north) {\tiny\url{https://virtuale.unibo.it/course/view.php?id=84459} (A-L)};
    \end{tikzpicture}
    \titlepage
  \end{frame}
}
