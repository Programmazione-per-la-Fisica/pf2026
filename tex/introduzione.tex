...
\begin{frame}{Pratica di programmazione, in aula e a casa}

  \begin{itemize}
  \item A programmare si impara programmando
  \begin{itemize}
    \item Il vostro codice, all'inizio, non sarà "perfetto"
    \item Gli esercizi fatti in aula e laboratorio, da soli, non bastano
    \item Un buon rapporto teoria/pratica è 1 a 5 (all'inizio 1 a 10)
  \end{itemize}
  \item Noi docenti non vi giudichiamo (fino all'esame)
  \begin{itemize}
    \item Durante le esercitazioni in aula, interagite
    \item Fate lo stesso in laboratorio
  \end{itemize}
  \item Per rimanere "in pari" durante il primo ciclo di lezioni, cercate di
        fare esercizio per alcune ore a settimana
  \item Non interrompete la pratica tra il primo e il secondo ciclo!
  \end{itemize}
...
\begin{frame}{Orario primo semestre (A-L)}
  \begin{itemize}
  \item Lezione/esercitazione: lunedì ore 14-16
  \item Laboratorio: martedì ore 14-18, su due
...
\begin{frame}{Prossimi appuntamenti (A-L)}

  \begin{itemize}
  \item Giovedì 17/9 ore 9-11 lezione
  \item Martedì 22/9 in base ai turni dei lab, Aula 2 Irnerio
    ...
    \end{itemize}
  \item Lunedì 28/9 ore 14-16 lezione
...
\begin{frame}{Prossimi appuntamenti (A-L) \insertcontinuationtext}

  \begin{itemize}
  \item Lunedì 5/10 ore 14-16 lezione
...
\begin{frame}{Orario primo semestre (M-Z)}
  \begin{itemize}
  \item Lezione/esercitazione: venerdì, ore 14-16
  \item Laboratorio: martedì ore 9-13, su due
    turni ciascuno, nel Laboratorio Informatico (Aula 2) della sede in via Irnerio
    \begin{itemize}
    \item La partecipazione a Laboratorio è \textbf{obbligatoria}, previa
      iscrizione su \href{https://studenti.unibo.it/sol/}{Studenti Online}
...
\begin{frame}{Prossimi appuntamenti (M-Z)}

  \begin{itemize}
  \item Venerdì 18/9 ore 14-16 lezione
  \item Martedì 22/9 in base ai turni dei lab, Aula 2 Irnerio
    \begin{itemize}
    \item Installazione/configurazione computer personali
    \item In collaborazione con docenti di altri insegnamenti
    \end{itemize}
  \item Venerdì 25/9 ore 14-16
  \item Martedì 29/9 in base ai turni dei lab, Aula 2 Irnerio
    \begin{itemize}
    \item Introduzione a Linux/Unix
    \item Fortemente raccomandato per chi non ha familiarità con Linux/Unix, in
...
\begin{frame}{Prossimi appuntamenti (M-Z) \insertcontinuationtext}

  \begin{itemize}
  \item Venerdì 2/10 ore 14-16 lezione
  \item Martedì 6/10 in base ai turni dei lab, Aula 2 Irnerio
    \begin{itemize}
    \item (Probabile) primo laboratorio
    \item Obbligatorio
    \end{itemize}
  \item Venerdì 9/10 ore 14-16 lezione
  \end{itemize}
...
\begin{frame}{Course outline}
  ...
  %\end{itemize}
  \begin{tikzpicture}
    \draw[dashed, blue] (0,0) -- (\linewidth,0);
    \node[anchor=east, text=blue, font=\tiny] at (10.5,0.15) {first cycle};
    \node[anchor=east, text=blue, font=\tiny] at (10.5,-0.15) {second cycle};
  \end{tikzpicture}
  %\begin{itemize}
